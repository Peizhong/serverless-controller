...
func NewController(
	...
	fooInformer informers.ServerlessFuncInformer) *Controller {
	...
	controller := &Controller{
		...
		crdClientSet:      sampleclientset,
		deploymentsLister: deploymentInformer.Lister(),
		deploymentsSynced: deploymentInformer.Informer().HasSynced,
		crdLister:         fooInformer.Lister(),
		crdSynced:         fooInformer.Informer().HasSynced,
